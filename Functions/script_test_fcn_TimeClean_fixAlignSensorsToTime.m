% script_test_fcn_TimeClean_fixAlignSensorsToTime.m
% tests fcn_TimeClean_fixAlignSensorsToTime
...
% fixed_dataStructure = fcn_TimeClean_fixAlignSensorsToTime(BadDataStructure);
% fprintf(1,'\nCASE 1: Done!\n\n');
% 
% % Make sure it worked
...
% fixed_dataStructure = fcn_TimeClean_fixAlignSensorsToTime(BadDataStructure,'', fid);
% fprintf(1,'\nCASE 2: Done!\n\n');
% 
% % Make sure it worked
% [flags, ~] = fcn_TimeClean_checkDataTimeConsistency(fixed_dataStructure);
...
% fixed_dataStructure = fcn_TimeClean_fixAlignSensorsToTime(BadDataStructure,'GPS', fid);
% fprintf(1,'\nCASE 3: Done!\n\n');
% 
% % Make sure it worked
% [flags, ~] = fcn_TimeClean_checkDataTimeConsistency(fixed_dataStructure);
...
temp = fcn_TimeClean_fixAlignSensorsToTime(dataStructure,[],fid);
