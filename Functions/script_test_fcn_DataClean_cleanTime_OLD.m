% script_test_fcn_DataClean_cleanTime_OLD.m
% tests fcn_DataClean_cleanTime_OLD.m
...
if 1==0
    ...
    dataStructure_cleanedTime = fcn_DataClean_cleanTime_OLD(dataStructure_cleanedNames, (fid), (Flags), (saveFlags), (plotFlags));
