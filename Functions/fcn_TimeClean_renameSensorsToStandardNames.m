function updated_dataStructure = fcn_TimeClean_renameSensorsToStandardNames(dataStructure,varargin)

% fcn_TimeClean_renameSensorsToStandardNames
% renames sensor fields to standard names
%
% FORMAT:
%
%      updated_dataStructure = fcn_TimeClean_renameSensorsToStandardNames(dataStructure,(fid))
%
% INPUTS:
%
...
% EXAMPLES:
%
%     See the script: script_test_fcn_TimeClean_renameSensorsToStandardNames
