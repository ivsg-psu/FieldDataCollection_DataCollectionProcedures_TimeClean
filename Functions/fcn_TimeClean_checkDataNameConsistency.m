function [flags, offending_sensor] = fcn_TimeClean_checkDataNameConsistency(dataStructure,varargin)
%% fcn_TimeClean_checkDataNameConsistency
...
% FORMAT:
%
%      [flags,offending_sensor] = fcn_TimeClean_checkDataNameConsistency(dataStructure,(fid),(figNum))
%
% INPUTS:
%
...
% EXAMPLES:
%
%     See the script: script_test_fcn_TimeClean_checkDataNameConsistency
...
% REVISION HISTORY:
% 
% As: fcn_DataClean_checkDataNameConsistency
%
...
% 
% As: fcn_TimeClean_checkDataNameConsistency
%
